...
<footer class="footer">
    <div class="container">
        ...
        <p class="footer__desc">This PHP diary project allows users to systematically document and reflect on their
            learning journey, enhancing retention and providing valuable insights into their personal growth and
            development.</p>
    </div>
</footer>
</body>
